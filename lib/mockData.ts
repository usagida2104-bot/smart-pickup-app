...
export const MOCK_WHITEBOARD_STATE: BoardState = {
  columns: [
    {
      id: "shift-1", shiftId: "shift-1", vehicleId: "v-stepwgn", vehicleName: "ステップワゴン", driverName: "宇佐見", capacity: 8,
      children: ["c-sato", "c-suzuki", "c-takahashi"].map(id => toMagnet(id))
    },
    {
      id: "shift-2", shiftId: "shift-2", vehicleId: "v-voxy", vehicleName: "VOXY", driverName: "増子", capacity: 8,
      children: []
    },
    {
      id: "shift-3", shiftId: "shift-3", vehicleId: "v-nvan", vehicleName: "Nバン", driverName: "内山", capacity: 4,
      children: ["c-ito", "c-watanabe"].map(id => toMagnet(id))
    },
    {
      id: "shift-4", shiftId: "shift-4", vehicleId: "v-isis", vehicleName: "アイシス", driverName: "つち", capacity: 7,
      children: ["c-yamamoto"].map(id => toMagnet(id))
    },
    {
      id: "shift-5", shiftId: "shift-5", vehicleId: "v-spacia", vehicleName: "SPACIA", driverName: "大平", capacity: 4,
      children: ["c-kobayashi"].map(id => toMagnet(id))
    },
    {
      id: "shift-6", shiftId: "shift-6", vehicleId: "v-boon", vehicleName: "BOON", driverName: "須田", capacity: 5,
      children: ["c-kato", "c-yoshida"].map(id => toMagnet(id))
    },
    {
      id: "shift-7", shiftId: "shift-7", vehicleId: "v-sienta", vehicleName: "Sienta", driverName: "熊田", capacity: 7,
      children: ["c-yamada"].map(id => toMagnet(id))
    },
    {
      id: "shift-8", shiftId: "shift-8", vehicleId: "v-note", vehicleName: "NOTE", driverName: "矢内", capacity: 5,
      children: []
    },
    {
      id: "shift-9", shiftId: "shift-9", vehicleId: "v-sienta", vehicleName: "Sienta", driverName: "理事長", capacity: 7,
      children: []
    },
    {
      id: "shift-10", shiftId: "shift-10", vehicleId: "v-every", vehicleName: "Every", driverName: "高宮", capacity: 4,
      children: []
    }
  ],
  unassigned: {
